...
const Cgv = () => (
  <section>
    ...
    <p>
      ...
      A plus de 30 jours avant départ nous vous demanderons de verser des arrhes
      correspondant à :
      - 30 % du prix global de votre location et des éventuelles prestations
      complémentaires intégrées ou non et notamment restauration, clubs enfants,
      stages sportifs...,
      100 % du prix global des éventuelles prestations de transports (vols,
      transfert, location de voiture, transports ferroviaires), des frais de
      dossier et des primes d'assurance si vous souhaitez les souscrire.
      Si vous partez dans les 30 jours suivant votre réservation nous vous
      demanderons 100% du prix du séjour (sauf dans le cas du paiement en 4x,
      voir ci-après).
      Toute réservation implique la communication d'une adresse électronique
      ...
      complémentaires est exigible (sauf en cas de paiement en plusieurs fois):
      - au plus tard trente (30) jours avant le début de votre séjour pour une
      réservation,
      ou immédiatement lors de la souscription pour toute réservation de dernière
      minute intervenant moins de trente (30) jours avant le début du séjour, dans
      le cadre d'offres spécifiques.
      Le paiement complet du prix ainsi que la transmission d'informations nécessaires
      ...
      Chèques acceptés : bancaires, vacances, cadeaux
      Pour tout paiement par un moyen autre que la carte bancaire, des frais de gestion
      d'un montant minimum de dix-huit (18) euros et pouvant aller jusqu'à 10% du prix total
      de la réservation, sont appliqués.
      Nos factures sont à régler au plus tard 30 jours avant la date du départ ou en conformité
      ...
      demande de O’Chalet.
      En aucun cas, les paiements ne pourront être suspendus, ni faire l'objet d'une quelconque
      ...
      de son séjour.
      Dans le cas où le séjour est annulé pour des circonstances de force majeure ou pour des
      raisons tenant à la sécurité du voyageur, le client ne peut prétendre à une
      quelconque indemnité.
      Pour tout paiement en espèce effectué directement sur site, dans la limite des
      plafonds légaux en vigueur à la date dudit paiement, nous nous réservons la possibilité
      d'appliquer des frais de service d'un montant de cinq (5) euros.
      Paiement avec une subvention: Dans le cadre d'un paiement réalisé en tout ou partie
      ...
      de votre hébergement et ses prestations réservées.
    </p>
    ...
    <p>
      ...
      pas tous équipés de sièges et de tables.
    ...
    <p>
      Nous nous efforcerons d'accepter autant que possible vos demandes de modification,
      ...
      votre demande et en fonction du type de modification. 4.2. Annulation de dossier
      En cas d'annulation, vous devez nous en informer par mail à l'adresse contact@ochalet.fr: la
      ...
      seront retenus ;
      Annulation entre 60 jours et 46 jours avant le départ : 30 % du montant total du
      séjour seront dus et payables immédiatement ;
      Annulation entre 45 jours et 30 jours avant le départ : 50 % du montant total du
      séjour seront dus et payables immédiatement ;
      Annulation entre 29 jours et 15 jours avant le départ : 75 % du montant total du
      séjour seront dus et payables immédiatement ;
      Annulation moins de 15 jours avant le départ : le prix total du séjour, options comprises,
      restera dû à O’Chalet;
      Toute demande d'annulation sera définitive.
      Tout séjour commencé est considéré comme intégralement consommé par vous et ne donne
      ...
      Nous attirons votre attention sur le fait que les activités liées à l'organisation et
      ...
      vente à distance. REMBOURSEMENT GARANTI LIÉ AU COVID-19 : Remboursement si votre séjour
      ...
      de fermer des stations de ski. Cette garantie ne s'applique pas aux autres motifs
      ...
      pourrez prétendre à aucun remboursement ; En cas de modification d'options
